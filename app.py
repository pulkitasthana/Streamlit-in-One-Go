...
st.subheader('Hello Geeks, Welcome to GFG')            #subheader
st.text('Hello Geeks, Welcome to GFG')                 #text
...
user_input = st.text_area('Write something interesting about yourself')
st.write(user_input)
